    ...
    class AzureRM
      ...
      class Real
        ...
        def setup_params(image_config)
          storage_profile_image = Azure::Profiles::Latest::Compute::Models::ImageStorageProfile.new
          storage_profile_image.os_disk = create_generalized_os_disk_image(image_config)
          image = Azure::Profiles::Latest::Compute::Models::Image.new
        ...
        def create_generalized_os_disk_image(image_config)
          os_disk_image = Azure::Profiles::Latest::Compute::Models::ImageOSDisk.new
          ...
          os_disk_image.caching = Azure::Profiles::Latest::Compute::Models::CachingTypes::ReadWrite
          os_disk_image
        end
      end
      ...
      class Mock
        def create_image(*)
          ...
          image_mapper = Azure::Profiles::Latest::Compute::Models::Image.mapper
