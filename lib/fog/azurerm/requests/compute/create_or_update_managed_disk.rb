    ...
    class AzureRM
      ...
      class Real
        ...
        def get_managed_disk_object(managed_disk_params)
          managed_disk = Azure::Profiles::Latest::Compute::Models::Disk.new
        ...
        def get_creation_data_object(data)
          creation_data = Azure::Profiles::Latest::Compute::Models::CreationData.new
          ...
          unless image_reference.nil?
            image_disk_reference = Azure::Profiles::Latest::Compute::Models::ImageDiskReference.new
        ...
        def get_encryption_settings_object(settings)
          encryption_settings = Azure::Profiles::Latest::Compute::Models::EncryptionSettings.new
          disk_encryption_key = Azure::Profiles::Latest::Compute::Models::KeyVaultAndSecretReference.new
          ...
          key_encryption_key = Azure::Profiles::Latest::Compute::Models::KeyVaultAndKeyReference.new
      ...
      class Mock
        def create_or_update_managed_disk(*)
          ...
          disk_mapper = Azure::Profiles::Latest::Compute::Models::Disk.mapper
