    ...
    class AzureRM
      ...
      class Real
        ...
        def create_virtual_machine_extension_object(virtual_machine_extension)
          vm_extension = Azure::Profiles::Latest::Compute::Models::VirtualMachineExtension.new
      ...
      class Mock
        def add_or_update_vm_extension(*)
          ...
          extension_mapper = Azure::Profiles::Latest::Compute::Models::VirtualMachineExtension.mapper
