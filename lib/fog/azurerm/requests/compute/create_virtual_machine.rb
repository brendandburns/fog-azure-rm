    ...
    class AzureRM
      ...
      class Real
        def create_virtual_machine(vm_config, async = false)
          ...
          vm = Azure::Profiles::Latest::Compute::Models::VirtualMachine.new
        ...
        def get_hardware_profile(vm_size)
          hw_profile = Azure::Profiles::Latest::Compute::Models::HardwareProfile.new
        ...
        def get_os_profile(vm_config)
          ...
          os_profile = Azure::Profiles::Latest::Compute::Models::OSProfile.new
        ...
        def get_windows_config(provision_vm_agent, enable_automatic_updates)
          windows_config = Azure::Profiles::Latest::Compute::Models::WindowsConfiguration.new
        ...
        def get_linux_config(disable_password_auth, ssh_key_path, ssh_key_data)
          linux_config = Azure::Profiles::Latest::Compute::Models::LinuxConfiguration.new
          linux_config.disable_password_authentication = disable_password_auth

          unless ssh_key_path.nil? || ssh_key_data.nil?
            ssh_config = Azure::Profiles::Latest::Compute::Models::SshConfiguration.new
            ssh_public_key = Azure::Profiles::Latest::Compute::Models::SshPublicKey.new
        ...
        def get_network_profile(network_interface_card_ids)
          ...
          network_interface_card_ids.each_with_index do |id, index|
            nic = Azure::Profiles::Latest::Compute::Models::NetworkInterfaceReference.new
            nic.id = id
            nic.primary = index == PRIMARY_NIC_INDEX
            network_interface_cards << nic
          end

          network_profile = Azure::Profiles::Latest::Compute::Models::NetworkProfile.new
        ...
        def get_unmanaged_vm_storage_profile(vm_config)
          ...
          storage_profile = Azure::Profiles::Latest::Compute::Models::StorageProfile.new
          # Set OS disk VHD path
          os_disk = Azure::Profiles::Latest::Compute::Models::OSDisk.new
          vhd = Azure::Profiles::Latest::Compute::Models::VirtualHardDisk.new
          ...
          if vhd_path.nil? && image_ref.nil?
            ...
            img_vhd = Azure::Profiles::Latest::Compute::Models::VirtualHardDisk.new
            ...
            storage_profile.image_reference = Azure::Profiles::Latest::Compute::Models::ImageReference.new
        ...
        def get_managed_vm_storage_profile(vm_config)
          ...
          storage_profile = Azure::Profiles::Latest::Compute::Models::StorageProfile.new
          os_disk = Azure::Profiles::Latest::Compute::Models::OSDisk.new
          managed_disk = Azure::Profiles::Latest::Compute::Models::ManagedDiskParameters.new
        ...
        def image_reference(publisher, offer, sku, version)
          image_reference = Azure::Profiles::Latest::Compute::Models::ImageReference.new
        ...
        def configure_os_disk_object(os_disk, os_disk_name, os_disk_caching, os_disk_size, platform, vm_name)
          ...
          os_disk.create_option = Azure::Profiles::Latest::Compute::Models::DiskCreateOptionTypes::FromImage
          os_disk.caching = unless os_disk_caching.nil?
                              case os_disk_caching
                              when 'None'
                                Azure::Profiles::Latest::Compute::Models::CachingTypes::None
                              when 'ReadOnly'
                                Azure::Profiles::Latest::Compute::Models::CachingTypes::ReadOnly
                              when 'ReadWrite'
                                Azure::Profiles::Latest::Compute::Models::CachingTypes::ReadWrite
                              end
                            end
          os_disk
        end
      ...
      class Mock
        def create_virtual_machine(*)
          ...
          vm_mapper = Azure::Profiles::Latest::Compute::Models::VirtualMachine.mapper
