    ...
    class AzureRM
      ...
      class Real
        ...
        def get_vault_param_object(vault_hash)
          vault_param = Azure::KeyVault::Models::VaultCreateOrUpdateParameters.new
        ...
        def get_vault_properties_object(vault_hash)
          vault_properties = Azure::KeyVault::Models::VaultProperties.new
        ...
        def get_sku_object(vault_hash)
          sku = Azure::KeyVault::Models::Sku.new
        ...
        def get_access_policy_entry_object(access_policy_hash)
          access_policy_entry = Azure::KeyVault::Models::AccessPolicyEntry.new
        ...
        def get_permission_object(permission_hash)
          permission = Azure::KeyVault::Models::Permissions.new
      ...
      class Mock
        def create_or_update_vault(*)
          ...
          vault_mapper = Azure::KeyVault::Models::Vault.mapper
