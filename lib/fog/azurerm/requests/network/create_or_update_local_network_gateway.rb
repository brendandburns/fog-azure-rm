    ...
    class AzureRM
      ...
      class Real
        ...
        def get_local_network_gateway_object(local_network_gateway_params)
          local_network_gateway = Azure::Profiles::Latest::Network::Models::LocalNetworkGateway.new
      ...
      class Mock
        def create_or_update_virtual_network_gateway(*)
          ...
          local_network_gateway_mapper = Azure::Profiles::Latest::Network::Models::LocalNetworkGateway.mapper
