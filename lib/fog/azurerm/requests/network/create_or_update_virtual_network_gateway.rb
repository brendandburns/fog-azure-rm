    ...
    class AzureRM
      ...
      class Real
        ...
        def get_network_gateway_object(virtual_network_params)
          network_gateway = Azure::Profiles::Latest::Network::Models::VirtualNetworkGateway.new
        ...
        def get_bgp_settings(virtual_network_params)
          bgp_settings = Azure::Profiles::Latest::Network::Models::BgpSettings.new
        ...
        def get_virtual_network_gateway_sku(virtual_network_params)
          sku = Azure::Profiles::Latest::Network::Models::VirtualNetworkGatewaySku.new
        ...
        def get_vpn_client_config(vpn_client_config)
          client_config = Azure::Profiles::Latest::Network::Models::VpnClientConfiguration.new

          address_pool = Azure::Profiles::Latest::Network::Models::AddressSpace.new
        ...
        def get_root_certificates(root_certificates)
          ...
          root_certificates.each do |root_cert|
            root_certificate = Azure::Profiles::Latest::Network::Models::VpnClientRootCertificate.new
        ...
        def get_revoked_certificates(revoked_certificates)
          ...
          revoked_certificates.each do |revoked_cert|
            revoked_certificate = Azure::Profiles::Latest::Network::Models::VpnClientRevokedCertificate.new
        ...
        def get_ip_configurations(ip_configurations)
          ...
          ip_configurations.each do |ip_config|
            ip_configuration = Azure::Profiles::Latest::Network::Models::VirtualNetworkGatewayIPConfiguration.new
