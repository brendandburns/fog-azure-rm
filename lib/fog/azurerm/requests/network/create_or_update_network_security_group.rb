    ...
    class AzureRM
      ...
      class Real
        ...
        def get_security_group_object(security_rules, location, tags)
          security_group = Azure::Profiles::Latest::Network::Models::NetworkSecurityGroup.new
        ...
        def get_security_rule_objects(security_rules)
          ...
          security_rules.each do |sr|
            security_rule = Azure::Profiles::Latest::Network::Models::SecurityRule.new
      ...
      class Mock
        def create_or_update_network_security_group(resource_group_name, security_group_name, location, security_rules)
          ...
          nsg_mapper = Azure::Profiles::Latest::Network::Models::NetworkSecurityGroup.mapper
