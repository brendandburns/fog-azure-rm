    ...
    class AzureRM
      ...
      class Real
        ...
        def get_public_ip_object(name, location, public_ip_allocation_method, idle_timeout_in_minutes, domain_name_label, tags)
          public_ip = Azure::Profiles::Latest::Network::Models::PublicIPAddress.new
          public_ip.name = name
          ...
          unless domain_name_label.nil?
            public_ip.dns_settings = Azure::Profiles::Latest::Network::Models::PublicIPAddressDnsSettings.new
      ...
      class Mock
        def create_public_ip(resource_group, name, location, public_ip_allocation_method)
          ...
          public_ip_mapper = Azure::Profiles::Latest::Network::Models::PublicIPAddress.mapper
