    ...
    class AzureRM
      ...
      class Real
        ...
        def get_circuit_authorization_object(circuit_authorization_params)
          circuit_authorization = Azure::Profiles::Latest::Network::Models::ExpressRouteCircuitAuthorization.new
      ...
      class Mock
        def create_or_update_express_route_circuit_authorization(*)
          ...
          authorization_mapper = Azure::Profiles::Latest::Network::Models::ExpressRouteCircuitAuthorization.mapper
