    ...
    class AzureRM < Fog::Service
      ...
      class Real
        def initialize(options)
          ...
          @compute_mgmt_client = ::Azure::Profiles::Latest::Compute::ComputeManagementClient.new(credentials, resource_manager_endpoint_url(options[:environment]))
          @compute_mgmt_client.subscription_id = options[:subscription_id]
          @compute_mgmt_client.add_user_agent_information(telemetry)
          @storage_mgmt_client = ::Azure::Storage::StorageManagementClient.new(credentials, resource_manager_endpoint_url(options[:environment]))
