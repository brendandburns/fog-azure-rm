    ...
    class AzureRM < Fog::Service
      ...
      class Real
        def initialize(options)
          ...
          @traffic_mgmt_client = ::Azure::Profiles::Latest::TrafficManager::TrafficManagerManagementClient.new(credentials, resource_manager_endpoint_url(options[:environment]))
