    ...
    module Compute
      ...
      class AvailabilitySet
        def self.create_unmanaged_availability_set_response(compute_client)
          ...
          availability_set_mapper = Azure::Profiles::Latest::Compute::Models::AvailabilitySet.mapper
        ...
        def self.list_availability_set_response(sdk_compute_client)
          ...
          availability_set_mapper = Azure::Profiles::Latest::Compute::Models::AvailabilitySetListResult.mapper
