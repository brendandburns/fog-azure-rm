...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'azure_mgmt_compute', '~> 0.19.3'
  spec.add_dependency 'azure_mgmt_resources', '~> 0.18.0'
  spec.add_dependency 'azure_mgmt_storage', '~> 0.22.0'
  spec.add_dependency 'azure_mgmt_network', '~> 0.24.1'
  spec.add_dependency 'azure_mgmt_dns', '~> 0.17.5'
  spec.add_dependency 'azure_mgmt_traffic_manager', '~> 0.17.4git'
  spec.add_dependency 'azure_mgmt_sql', '~> 0.19.1'
  spec.add_dependency 'azure_mgmt_key_vault', '~> 0.17.6'
  spec.add_dependency 'azure-storage-blob', '= 2.0.1'
